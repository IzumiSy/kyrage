...
const DevDatabaseUnsupportedError = new Error(
  "Dev Database is not supported in SQLite"
);
...
export class SQLiteKyrageDialect implements KyrageDialect {
  ...
  getDevDatabaseImageName(): string {
    throw DevDatabaseUnsupportedError;
  }
  ...
  createDevDatabaseContainer(_image: string): StartableContainer {
    throw DevDatabaseUnsupportedError;
  }
}
